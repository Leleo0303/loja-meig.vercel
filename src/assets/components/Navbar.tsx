...
export const Navbar: React.FC<NavbarProps> = ({ onOpenCart }) => {
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-[#FFF8FB]/80 backdrop-blur-md border-b border-[#F7D7E1]/30 px-6 py-2.5 flex justify-between items-center transition-all duration-300">
      ...
      {/* LOGO AMPLIADA E INTEGRADA AO ESTILO PREMIUM DA MARCA */}
      ...
      {/* MENU DE NAVEGAÇÃO DE LUXO */}
      <ul className="hidden md:flex space-x-8 text-sm font-medium tracking-wider text-[#2C2C2C]/80">
        <li className="hover:text-[#FF7EB6] transition-colors cursor-pointer relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-[#FF7EB6] hover:after:w-full after:transition-all after:duration-300">Início</li>
        <li className="hover:text-[#FF7EB6] transition-colors cursor-pointer relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-[#FF7EB6] hover:after:w-full after:transition-all after:duration-300">Coleções</li>
        <li className="hover:text-[#FF7EB6] transition-colors cursor-pointer relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-[#FF7EB6] hover:after:w-full after:transition-all after:duration-300">Looks</li>
      ...
      {/* BOTÃO DE CHAMADA PARA AÇÃO (Agora abre a Sacola ao clicar) */}
      <button 
        onClick={onOpenCart}
